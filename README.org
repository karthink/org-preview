...
/Note: This library was a proof of concept and will not be worked on further, it will be archived eventually./

/Instead this feature and many more will be included in Org mode, likely in version +9.7+ 9.8./

- /[[https://www.youtube.com/watch?v=n-AfvuV-bYo][Here is a demo]] of some of the new features/
- /[[https://abode.karthinks.com/org-latex-preview/][Here are some set up instructions]] if you would like to try the development branch of Org mode containing these features./
